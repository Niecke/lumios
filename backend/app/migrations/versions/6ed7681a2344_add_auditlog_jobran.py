...
def upgrade():
    ...
    with op.batch_alter_table('library', schema=None) as batch_op:
        batch_op.drop_column('use_originals_as_preview')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('library', schema=None) as batch_op:
        batch_op.add_column(sa.Column('use_originals_as_preview', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False, nullable=False))
